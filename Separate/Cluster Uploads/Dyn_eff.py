...
def load_or_exec(filename, directory, function, execute_arguments):
    command = 'T'#input('Rewrite %s in %s (T/F):'%(filename, directory))
...
rewrite_RAW = 'T'#input('Rewrite Raw data directory(T/F):')
...
rewrite_RAW_sr = 'T'#input('Rewrite Raw SR file:')
...
rewrite_Asymptote = 'T'#input('Rewrite Asymptote data directory(T/F):')

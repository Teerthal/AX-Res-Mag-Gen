...
Master_path = "/media/teerthal/Repo 2/Reheating/Set_14"
...
#rho_peak_plot(p, alpha, k, x_len, a_stack, Master_path, f, trigger_matrix, kill_arr, Phi_stack, asymp_stack)
